...
class OpaySend extends OpayAio
{
    ...
    static function CheckOutString($paymentButton,$target = "_self",$arParameters = array(),$arExtend = array(),$HashKey='',$HashIV='',$ServiceURL=''){
        ...
        $szHtml .=             "<input type=\"hidden\" name=\"CheckMacValue\" value=\"{$szCheckMacValue}\" />";
        $szHtml .=             "<button class=\"btn btn-default\" onclick='backCheckout()'>Back</button>&nbsp;";
        $szHtml .=             "<input class='btn btn-primary' type=\"submit\" id=\"__paymentButton\" value=\"{$paymentButton}\" />";
        $szHtml .=         '</form>';
        //$szHtml .=     '</body>';
        //$szHtml .= '</html>';
