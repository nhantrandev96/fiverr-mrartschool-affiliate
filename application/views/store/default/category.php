	...
	<section class="jumbotron text-center">
	    <div class="container">
			<div class="category-box">
				...
				?>
				<img style="max-width: 200px" src="<?= base_url($image) ?>">
				<div>
					...
					<div class="card h-100">
						...
						<?php if($product['country_code']){ ?>
							<div class="country-flag">
								<span class="flag"><img src="<?php echo getFlag($product['country_code']) ?>"></span>
								<span class="country"><?php echo $product['country_name'] ?></span>, 
								<span class="state"><?php echo $product['state_name'] ?></span>
							</div>
						<?php } ?>
