                            	...
                            	<div class="login-reg-form">
        	                        <div class="tab-content">
        	                            <div class="tab-pane fade show active" role="tabpanel" id="login">
        	                                ...
        	                                <p class="mb-0 subtitle d-block text-center mt-3">Don't have an account yet? <a href="#register" class="toggle-sign-up">Sign up</a></p>
        	                            </div>
        	                            ...
        	                            <div class="tab-pane fade" role="tabpanel" id="register">
        	                                ...
        	                                <?= $register_fomm ?>
        	                                <p class="mb-0 subtitle d-block text-center mt-3">Already have an account? <a href="#login" class="toggle-sign-in">Log in</a></p>
        	                            </div>
        	                        </div>
        	                    </div>
