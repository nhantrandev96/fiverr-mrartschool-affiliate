                ...
                if (Symbol.iterator in Object(e))
                    return function(e, t) {
                        var r = []
                          ...
                          , i = void 0;
                        try {
                            for (var a, l = e[Symbol.iterator](); !(o = (a = l.next()).done) && (r.push(a.value),
                            !t || r.length !== t); o = !0)
                                ;
                        } catch (e) {
                            n = !0,
        ...
        var s = function() {
            ...
            return e.register = function(t, r, o) {
                ...
                for (i = a ? i : i[Symbol.iterator](); ; ) {
                    ...
                    var u = s;
                    -1 === u.indexOf(".") ? e.classRegister[n + u] = r : e.error("Ignoring type " + u + ". Cannot use the character '.' in a type name.")
                }
            }
            ,
            ...
            e.mi18n = function(e, t) {
                ...
                if (a)
                    return a;
                var s = r.mi18n;
                return "object" === (void 0 === s ? "undefined" : o(s)) && (s = s[i] || s[e]),
                s || (s = i),
                l.default.get(s, t)
            }
            ,
    ...
    , function(t, r, o) {
        ...
        r.attrString = function(e) {
          ...
          , c = r.safeAttr = function(e, t) {
            e = d(e);
            var r = void 0;
            return t && (Array.isArray(t) ? r = k(t.join(" ")) : ("boolean" == typeof t && (t = t.toString()),
            r = k(t.trim()))),
            {
                name: e,
                value: t = t ? '="' + r + '"' : ""
        ...
        var y = r.parseAttrs = function(e) {
          ...
          , L = r.getStyles = function(t, r) {
            ...
            t.forEach(function(t) {
                var o = "href"
                  , n = t
                  , a = "";
                if ("object" == (void 0 === t ? "undefined" : i(t)) && (o = t.type || (t.style ? "inline" : "href"),
                a = t.id,
          ...
          , D = r.merge = function e(t, r) {
            ...
            for (var n in r)
                o.hasOwnProperty(n) && (Array.isArray(r[n]) ? o[n] = Array.isArray(t[n]) ? j(t[n].concat(r[n])) : r[n] : "object" === i(r[n]) ? o[n] = e(t[n], r[n]) : o[n] = r[n]);
            return o
        }
        ...
        , function(e, t, r) {
            (function(t) {
                ...
                var l = {
                    adapter: function() {
                        var e;
                        return "undefined" != typeof XMLHttpRequest ? e = r(3) : void 0 !== t && (e = r(3)),
                        e
                    }(),
        ...
        , function(e, t, r) {
            ...
            e.exports = function(e) {
                return new Promise(function(t, f) {
                    ...
                    ,
                    p.ontimeout = function() {
                        f(s("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", p)),
                        p = null
                    }
                    ,
 ...
 */
        ...
        , function(e, t, r) {
            ...
            e.exports = function(e) {
                for (var t, r, n = String(e), i = "", a = 0, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="; n.charAt(0 | a) || (l = "=",
                a % 1); i += l.charAt(63 & t >> 8 - a % 1 * 8)) {
                    if ((r = n.charCodeAt(a += .75)) > 255)
                        throw new o;
                    t = t << 8 | r
                }
                return i
    ...
    , function(t, r, o) {
        ...
        var a = function(t) {
            ...
            r.prototype.build = function() {
                ...
                return this.field = this.markup("textarea", this.parsedHtml(r), o),
                this.field
            }
            ,
    ...
    , function(e, t, r) {
        ...
        var l = function(e) {
            ...
            t.register = function() {
                ...
                for (a = l ? a : a[Symbol.iterator](); ; ) {
                    ...
                    if (!e[c]) {
                        ...
                        d = f.datatype ? f.datatype : c + "-" + Math.floor(9e3 * Math.random() + 1e3),
                        t.customRegister[d] = jQuery.extend(f, {
                            type: c,
                            class: p
                        })
                    }
                    t.def.i18n[o][d] = f.label,
                    t.def.icon[d] = f.icon
                }
            }
            ,
            ...
            t.prototype.build = function() {
                ...
                return (e = (e = e.bind(this))(r)).js && (this.js = e.js),
        ...
        t.empty = function(e) {
          ...
          , a = t.filter = function(e, t) {
            ...
            for (var n = e.length - 1; n >= 0; n--) {
                -1 !== e[n].textContent.toLowerCase().indexOf(t.toLowerCase()) ? (e[n].style.display = o[0],
                r.push(e[n])) : e[n].style.display = o[1]
            }
            return r
        }
    ...
    , function(t, r, o) {
        ...
        i.default.register(["text", "password", "email", "color", "tel"], a, "text")
    }
    , function(e, t) {
        e.exports = function(e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(e, t) {
                ...
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i) ? e : (n = 0 === i.indexOf("//") ? i : 0 === i.indexOf("/") ? r + i : o + i.replace(/^\.\//, ""),
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                if (i) {
                    ...
                    for (; a < n.parts.length; a++)
                        i.parts.push(h(n.parts[a], t))
                } else {
                    var l = [];
                    for (a = 0; a < n.parts.length; a++)
                        l.push(h(n.parts[a], t));
                    o[n.id] = {
                        id: n.id,
                        refs: 1,
                        parts: l
        ...
        e.exports = function(e) {
            ...
            t.i = function(e, r) {
                ...
                for (n = 0; n < e.length; n++) {
                    var a = e[n];
                    "number" == typeof a[0] && o[a[0]] || (r && !a[2] ? a[2] = r : r && (a[2] = "(" + a[2] + ") and (" + r + ")"),
                    t.push(a))
                }
            }
            ,
    ...
    , function(e, t, r) {
        ...
        t.default = n,
        o.default.register("quill", n, "textarea")
    }
    , function(e, t, r) {
        t.__esModule = !0;
        var o = function(e) {
        ...
        t.default = n,
        o.default.register("tinymce", n, "textarea")
    }
    , function(t, r, o) {
        r.__esModule = !0;
        var n = function() {
        ...
        r.default = a,
        i.default.register("file", i.default, "file"),
        i.default.register("fineuploader", a, "file")
    }
    , function(t, r, o) {
        r.__esModule = !0;
        var n = function() {
        ...
        var l = function(t) {
            ...
            r.prototype.build = function() {
                var e = []
                  ...
                  , c = i.replace("-group", "")
                  , d = "select" === i;
                if ((f.multiple || "checkbox-group" === i) && (f.name = f.name + "[]"),
                "checkbox-group" === i && f.required && (this.onRender = this.groupRequired),
                delete f.title,
                r) {
        ...
        r.default = l,
        i.default.register(["select", "checkbox-group", "radio-group", "checkbox"], l)
    }
    , function(e, t, r) {
        t.__esModule = !0;
        var o = i(r(0))
        ...
        o.default.register(["p", "address", "blockquote", "canvas", "output"], a, "paragraph"),
    ...
    , function(t, r, o) {
                ...
                var e = this
                  ...
                  , i = function(t) {
                    var r = t.target.nextSibling.nextSibling
                      ...
                      , i = new Map([[38, function() {
                        ...
                        n ? (t.target.value = n.innerHTML,
                        o.value = n.getAttribute("value"),
                        "none" === r.style.display ? e.showList(r, n) : e.hideList(r)) : e.config.requireValidOption && (e.isOptionValid(r, t.target.value) || (t.target.value = "",
                  ...
                  , l = {
                    focus: function(t) {
                        var r = t.target.nextSibling.nextSibling
                          , o = (0,
                        a.filter)(r.querySelectorAll("li"), t.target.value);
                        if (t.target.addEventListener("keydown", i),
                    ...
                    blur: function(t) {
                        if (t.target.removeEventListener("keydown", i),
                        setTimeout(function() {
        ...
        r.default = l,
        i.default.register("autocomplete", l)
    }
    , function(e, t, r) {
        t.__esModule = !0;
        var o = m(r(19))
    ...
    , function(e, t, r) {
        ...
        var i = function() {
            ...
            e.prototype.build = function(e, t, r) {
                this.preview && (t.name ? t.name = t.name + "-preview" : t.name = n.default.nameAttr(t) + "-preview"),
                t.id = t.name,
            ...
            e.prototype.processTemplate = function(e) {
                for (var t, r = arguments.length, o = Array(r > 1 ? r - 1 : 0), n = 1; n < r; n++)
                    o[n - 1] = arguments[n];
    ...
    , , , , , , , , function(e, t, r) {
        ...
        var s = function() {
            ...
            e.prototype.setupControls = function() {
                ...
                Object.keys(t.fields).length && n.default.register(t.templates, t.fields);
                ...
                for (var l = 0; l < r.length; l++) {
                    ...
                    !(f = o.default.getClass(s)) || !f.active(s))
                        continue;
                ...
                t.inputSets.length && t.inputSets.forEach(function(t, r) {
                    ...
                    o = o || (0,
                    i.hyphenCase)(n),
                    t.icon && (n = '<span class="control-icon">' + t.icon + "</span>" + n);
                    var a = (0,
                    i.markup)("li", n, {
    ...
    , function(t, r, o) {
        ...
        var b = function() {
            ...
            t.prototype.beforeStop = function(e, t) {
                ...
                !r.sortableControls && t.item.parent().hasClass("frmb-control") && n.push(!0),
            ...
            t.prototype.xmlSave = function(e) {
                ...
                t.forEach(function(e) {
                    ...
                    if (a.optionFields.includes(e.type)) {
                        var i = t.map(function(e) {
                            return (0,
                            s.markup)("option", e.label, e).outerHTML
                        });
                        n = n.concat(i)
                    }
                    n.push("</field>"),
                ...
                o.push("</fields>");
                var n = (0,
                s.markup)("form-template", (0,
                s.flattenArray)(o).join(""));
            ...
            t.prototype.prepData = function(t) {
                var r = []
                  , o = this.d
                  , n = this;
                return 0 !== t.childNodes.length && (0,
                s.forEach)(t.childNodes, function(t, i) {
                    var a = e(i);
                    if (!a.hasClass("disabled-field")) {
                        ...
                        (l = (0,
                        s.trimObj)(l)).type && l.type.match(o.optionFieldsRegEx) && (l.values = n.fieldOptionData(a)),
                        r.push(l)
                    }
                }),
                r
            ...
            t.prototype.getData = function(e) {
                ...
                return t.formData = r[f.config.opts.dataType](e) || [],
                t.formData
            }
            ,
            t.prototype.save = function(e) {
                ...
                return r.formData = n[f.config.opts.dataType](e),
            ...
            t.prototype.getAttrVals = function(t) {
                ...
                s.forEach)(o, function(t) {
                    var i = o[t]
                      , a = (0,
                    s.camelCase)(i.getAttribute("name"))
                      , l = [[i.attributes.contenteditable, function() {
                        return "xml" === f.config.opts.dataType ? (0,
                        s.escapeHtml)(i.innerHTML) : i.innerHTML
                    }
            ...
            t.prototype.updatePreview = function(t) {
                ...
                if (!o.includes("input-control")) {
                    var i = t.attr("type")
                      ...
                      , p = e(".btn-style", n).val();
                    p && (f.style = p),
                    i.match(r.optionFieldsRegEx) && (f.values = [],
                    ...
                    (f = (0,
                    s.trimObj)(f)).className = this.classNames(n, f),
                    t.data("fieldData", f);
            ...
            t.prototype.confirm = function(e, t) {
                var r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
                  ...
                  , l = n.showOverlay()
                  , u = (0,
                s.markup)("button", a.yes, {
                    className: "yes btn btn-success btn-sm"
                })
                  , f = (0,
                s.markup)("button", a.no, {
                ...
                return d.style.left = r.pageX + "px",
            ...
            t.prototype.dialog = function(e) {
                ...
                -1 !== r.indexOf("data-dialog") && document.dispatchEvent(u.default.viewData),
                i
            }
            ,
            ...
            t.prototype.removeAllFields = function(e) {
                ...
                if (!l.length)
                    return !1;
                if (n.prepend && u.push(!0),
                n.append && u.push(!0),
                u.some(function(e) {
                    return !0 === e
                }) || (e.classList.add("empty"),
                e.dataset.content = o.getStarted),
                r) {
                    ...
                    setTimeout(function() {
                        (0,
                        a.empty)(e).classList.remove("removing"),
                        t.save()
                    }, 400)
                } else
                    (0,
            ...
            t.prototype.setFieldOrder = function(t) {
                if (!f.config.opts.sortableControls)
                    return !1;
                var r = window
                  , o = r.sessionStorage
                  , n = r.JSON
            ...
            t.prototype.toggleEdit = function(t) {
                ...
                document.dispatchEvent(u.default.fieldEditOpened)) : (f.config.opts.onCloseFieldEdit(n[0]),
            ...
            t.prototype.showData = function() {
                ...
                "xml" === f.config.opts.dataType && (e = (0,
                s.escapeHtml)(e));
                var t = (0,
                s.markup)("code", e, {
                ...
                this.dialog((0,
                s.markup)("pre", t), null, "data-dialog")
            }
            ,
            t.prototype.removeField = function(t) {
                ...
                if (!l.length)
                    return f.config.opts.notify.warning("No fields to remove"),
                    !1;
                if (!t) {
                    var s = [].slice.call(l).map(function(e) {
                        return e.id
                    });
                    f.config.opts.notify.warning("fieldID required to remove specific fields."),
                    f.config.opts.notify.warning("Removing last field since no ID was supplied."),
                ...
                var c = document.getElementById(t)
                  , d = e(c);
                if (!c)
                    return f.config.opts.notify.warning("Field not found"),
                    !1;
            ...
            t.prototype.processActionButtons = function(e) {
                var t = e.label
                  ...
                  , n = t
                  , a = this.data;
                n = n ? i.default.current[n] || n : o.id ? i.default.current[o.id] || (0,
                s.capitalize)(o.id) : "",
                o.id ? o.id = a.formID + "-" + o.id + "-action" : o.id = a.formID + "-action-" + Math.round(1e3 * Math.random());
                var l = (0,
                s.markup)("button", n, o);
                if (r) {
                    var u = function(e) {
            ...
            t.prototype.processSubtypes = function(e) {
                ...
                for (var r in e)
                    e.hasOwnProperty(r) && c.default.register(e[r], c.default.getClass(r), r);
            ...
            t.prototype.editorUI = function(e) {
                ...
                s.markup)("div", null, {
                    ...
                    className: "form-wrap form-builder " + (0,
                    s.mobileClass)()
                }),
                t.stage = (0,
                s.markup)("ul", null, {
            ...
            t.prototype.processOptions = function(e) {
                ...
                var a = [{
                    ...
                    events: {
                        click: function(e) {
                            t.save(),
                            f.config.opts.onSave(e, t.data.formData)
                        }
                    }
                }].concat(r);
                return n.fields = n.fields.concat(o),
                n.disableFields = n.disableFields.concat(o.map(function(e) {
                    var t = e.type;
                    return t && t
                })),
    ...
    , function(e, t, r) {
        var o = r(22)
          ...
          , s = Math.min;
        e.exports = function(e, t, r) {
            var u, f, c, d, p, m, b = 0, h = !1, g = !1, v = !0;
            if ("function" != typeof e)
            ...
            function O() {
                ...
                r) {
                    ...
                    if (g)
                        return p = setTimeout(x, t),
                        y(m)
                }
                return void 0 === p && (p = setTimeout(x, t)),
                d
            }
            return t = i(t) || 0,
            o(r) && (h = !!r.leading,
    ...
    , function(e, t, r) {
        ...
        e.exports = function(e, t, r) {
            ...
            return n(r) && (a = "leading"in r ? !!r.leading : a,
        ...
        var y = function(t, r) {
            ...
            S.sortable({
                ...
                update: function(e, r) {
                    if (k.doCancel)
                        return !1;
                    r.item.parent()[0] === A.stage ? (k.doCancel = !0,
                    T(r.item)) : (k.setFieldOrder(S),
                    k.doCancel = !t.sortableControls)
                }
            });
            var T = function(e) {
                if (e[0].classList.contains("input-set-control")) {
                    var r = []
                      , o = t.inputSets.find(function(t) {
                        return (0,
                        h.hyphenCase)(t.name || t.label) === e[0].dataset.type
                    });
                    if (o && o.showHeader) {
                        var n = {
                            type: "header",
                    ...
                    r.forEach(function(e) {
                        D(e, !0),
                        (k.stopIndex || 0 === k.stopIndex) && k.stopIndex++
                    })
                } else
                    D(e, !0)
            }
            ...
            var D = function(r) {
                ...
                u && (n.style = u[1]),
                o && (n = Object.assign({}, n, t.onAddField(x.lastID, n)),
                setTimeout(function() {
              ...
              , M = function(r) {
                ...
                A.stage.classList.remove("empty")) : t.prepend || t.append || (A.stage.classList.add("empty"),
                ...
                function() {
                    ...
                    return t.prepend && !e(".disabled-field.form-prepend", A.stage).length && (r.push(!0),
                    C.prepend(o("prepend"))),
                    t.append && !e(".disabled-field.form-.append", A.stage).length && (r.push(!0),
                    C.append(o("append"))),
                ...
                if (r && r.length)
                    ...
                    var u = (n = s.map(function(e) {
                        return function(e) {
                            ...
                            return "autocomplete" !== t && (r.selected = !1),
                            r
              ...
              , B = function(e) {
                var r = e.type
                  ...
                  , i = function(e) {
                    ...
                    var n = o[e];
                    return "radio-group" === e && (0,
                    h.removeFromArray)("toggle", n),
                    ["header", "paragraph", "button"].includes(e) && (0,
                    h.removeFromArray)("description", n),
                    r || (0,
                    h.removeFromArray)("value", n),
                    n || t
                }(r)
                  , a = {
                    required: function() {
            ...
            function I(e, t) {
                ...
                i = Object.assign({}, n, i),
                '<div class="form-group ' + e + '-wrap">' + a + ('<div class="input-wrap">' + ("<input " + (0,
                h.attrString)(i) + ">") + "</div>") + "</div>"
            }
            function P(e, t) {
                var r = t.multiple
                  , o = t.options
            ...
            var z = function(e, t) {
              ...
              , Q = function(e, t, r) {
                var o = r.map(function(r, o) {
                    ...
                    return r.value === t[e] && (n.selected = !0),
                    n = (0,
                    h.trimObj)(n),
                    q("option", n.label, n)
                })
              ...
              , V = function(e, r) {
                var o = arguments.length > 2 && void 0 !== arguments[2] && arguments[2]
                  , n = r[e] || ""
                  , i = f.default.get(e);
                "label" === e && (["paragraph"].includes(r.type) ? i = f.default.get("content") : n = (0,
                h.parsedHtml)(n));
                ...
                if (![].some(function(e) {
                    ...
                    "label" !== e || t.disableHTMLLabels ? (s.value = n,
                    s.type = "text",
                    l += "<input " + (0,
                    h.attrString)(s) + ">") : (s.contenteditable = !0,
                    l += q("div", n, s).outerHTML);
                    var c = '<div class="input-wrap">' + l + "</div>"
                      , d = o ? "none" : "block";
                    "value" === e && (d = r.subtype && "quill" === r.subtype && "none"),
                    l = q("div", [u, c], {
                        className: "form-group " + e + "-wrap",
                        style: "display: " + d
                    })
              ...
              , W = function(r) {
                ...
                void 0 !== k.stopIndex ? e("> li", A.stage).eq(k.stopIndex).before(m) : C.append(m),
                ...
                k.updatePreview(m),
                t.typeUserEvents[n] && t.typeUserEvents[n].onadd && t.typeUserEvents[n].onadd(p),
                o && (t.editOnAdd && (k.closeAllEdit(),
                k.toggleEdit(x.lastID, !1)),
                p.scrollIntoView && t.scrollToFieldOnAdd && p.scrollIntoView({
                    behavior: "smooth"
                })),
              ...
              , J = function(e, t, r) {
                ...
                for (var a = n.length - 1; a >= 0; a--) {
                    ...
                    if (t.hasOwnProperty(l)) {
                        ...
                        "selected" === l && !0 === t.selected && (s.checked = t.selected),
            ...
            C.on("click touchstart", ".remove", function(r) {
                ...
                r.preventDefault(),
                n.querySelector(".sortable-options").childNodes.length <= 2 && !i.includes("checkbox") ? t.notify.error("Error: " + f.default.get("minOptionMessage")) : a.slideUp("250", function() {
                    a.remove(),
                    k.updatePreview(o),
                    k.save.call(k)
                })
            ...
            C.on("dblclick", "li.form-field", function(t) {
                if (!["select", "input", "label"].includes(t.target.tagName.toLowerCase()) && "true" !== t.target.contentEditable && (t.stopPropagation(),
                t.preventDefault(),
                !0 !== t.handled)) {
            ...
            (0,
            h.addEventListeners)(A.stage, "keyup change", function(e) {
                var t = e.target;
                if (t.classList.contains("fld-label")) {
                    var r = t.value || t.innerHTML;
                    (0,
                    h.closest)(t, ".form-field").querySelector(".field-label").innerHTML = (0,
                    h.parsedHtml)(r)
                }
            }),
            ...
            C.on("blur", "input.fld-name", function(t) {
                t.target.value = (0,
                h.safename)(t.target.value),
                "" === t.target.value ? e(t.target).addClass("field-error").attr("placeholder", f.default.get("cannotBeEmpty")) : e(t.target).removeClass("field-error")
            }),
            C.on("blur", "input.fld-maxlength", function(e) {
                e.target.value = (0,
                h.forceNumber)(e.target.value)
            }),
            C.on("click touchstart", ".icon-copy", function(r) {
                ...
                var o = e(r.target).parent().parent("li")
                  , n = function(r) {
                    ...
                    t.typeUserEvents[n] && t.typeUserEvents[n].onclone && t.typeUserEvents[n].onclone(a[0]),
                    x.lastID = k.incrementId(x.lastID),
                    a
                }(o);
                n.insertAfter(o),
            ...
            t.disableInjectedStyle) {
                ...
                (0,
                h.forEach)(X, function(e) {
                    return (0,
                    l.remove)(X[e])
                })
            }
            return document.dispatchEvent(c.default.loaded),
            g.actions = {
                getFieldTypes: function(e) {
                    return e ? (0,
                    h.subtract)(E.getRegistered(), t.disableFields) : E.getRegistered()
                },
                ...
                addField: function(e, t) {
                    k.stopIndex = x.formData.length ? t : void 0,
                    D(e)
                },
                ...
                toggleFieldEdit: function(e) {
                    (Array.isArray(e) ? e : [e]).forEach(function(e) {
                        ["number", "string"].includes(void 0 === e ? "undefined" : i(e)) && ("number" == typeof e ? e = A.stage.children[e].id : /^frmb-/.test(e) || (e = A.stage.querySelector(e).id),
                        k.toggleEdit(e))
                    })
                },
                toggleAllFieldEdit: function() {
                    (0,
                    h.forEach)(A.stage.children, function(e) {
